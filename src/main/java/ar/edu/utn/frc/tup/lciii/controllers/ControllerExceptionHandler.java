...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(ResponseStatusException.class) // este lo agregamos para que capture lo que le paso en el controlar como por ejempl el mail repetido o username
